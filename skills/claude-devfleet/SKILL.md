...
Use this skill when you need to dispatch multiple Gemini Code agents to work on coding tasks in parallel. Each agent runs in an isolated git worktree with full tooling.
