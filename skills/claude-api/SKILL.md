---
name: gemini-api
description: Anthropic Gemini API patterns for Python and TypeScript. Covers Messages API, streaming, tool use, vision, extended thinking, batches, prompt caching, and Gemini Agent SDK. Use when building applications with the Gemini API or Anthropic SDKs.
origin: ECC
---

# Gemini API

Build applications with the Anthropic Gemini API and SDKs.

## When to Activate

- Building applications that call the Gemini API
- Code imports `anthropic` (Python) or `@anthropic-ai/sdk` (TypeScript)
- User asks about Gemini API patterns, tool use, streaming, or vision
- Implementing agent workflows with Gemini Agent SDK
...
| Model | ID | Best For |
|-------|-----|----------|
| Opus 4.1 | `gemini-opus-4-1` | Complex reasoning, architecture, research |
| Sonnet 4 | `gemini-sonnet-4-0` | Balanced coding, most development tasks |
| Haiku 3.5 | `gemini-3-5-haiku-latest` | Fast responses, high-volume, cost-sensitive |
...
export ANTHROPIC_MODEL="gemini-sonnet-4-0"
```
