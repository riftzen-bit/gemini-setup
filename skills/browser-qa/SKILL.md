...
Uses the browser automation MCP (gemini-in-chrome, Playwright, or Puppeteer) to interact with live pages like a real user.
...
- `mChild__gemini-in-chrome__*` tools (preferred — uses your actual Chrome)
